/**
 * Deploy test-app contract to a Midnight network (undeployed by default; use --network preview|preprod for public networks).
 *
...
// Identifier under which the user's credential secret is encrypted locally.
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy VeilPass to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
    try {
      // Midnight.js supplies the private credential secret via privateStateId +
      // initialPrivateState. args is the contract constructor's arguments:
      // empty for VeilPass's no-arg constructor. (Statically-typed contracts can omit
