...
/** One-time notice for a freshly generated wallet; never print secrets. */
export function formatWalletBackupNotice(
  ...
  return [
    '',
    `  New ${network} wallet generated.`,
    `  Its recovery material is saved locally in ${STATE_FILE_NAME} (gitignored).`,
    '  Back it up privately; it is intentionally never printed to command output.',
    '',
  ].join('\n');
}
